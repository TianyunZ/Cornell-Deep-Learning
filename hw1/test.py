...
if __name__ == "__main__":
    ...
    TRAIN_FILENAMES = ["cifar-10-batches-py/data_batch_" + str(i) for i in range(1, 6)]
    TEST_FILENAME = "cifar-10-batches-py/" + 'test_batch' # complete path of testing file
    META_FILENAME = "cifar-10-batches-py/" + 'batches.meta' # complete path of meta file

    # TRAIN_FILENAMES = ["cifar-10-batches-py/data_batch_1"]
    ...
    sftmx = Softmax(epochs=epochs, learningRate=learningRate, batchSize=batchSize,
                       wtHyper=regStrength, momentum=momentum)
